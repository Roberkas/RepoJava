...
public class Estudio {
    ...
    public Estudio(String nombre, String ciudad, String direccion, String dirweb, LocalDate fechafundacion, String pais, ArrayList telefonos, ArrayList peliculas) {
        this.nombre = nombre;
        this.ciudad = ciudad;
        this.direccion = direccion;
        this.dirweb = dirweb;
    ...
    public Estudio(String nombre, String ciudad, String direccion, String dirweb, LocalDate fechafundacion, String pais, ArrayList telefonos, Peliculas pelicula) {
        this.nombre = nombre;
        this.ciudad = ciudad;
        this.direccion = direccion;
        this.dirweb = dirweb;
    ...
    public void AñadirPelicula(Peliculas p1){
